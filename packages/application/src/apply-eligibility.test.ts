...
describe("checkApplyEligibility — real production regressions (Milestone 20)", () => {
  ...
  it.each([
    ...
    "Brand Designer",
    "Lead Brand Designer",
    "Brand Video Creator & KOL Partner",
    "Design Engineer",
    "Treasury Analyst",
    "Mobile App Developer",
    "Product Marketing Manager - Cards",
    ...
    "Blockchain Risk Control Analyst",
    "Listing Manager, Structured Digital Assets",
    "Growth Manager - Africa",
    "Product Lead, Data Licensing",
